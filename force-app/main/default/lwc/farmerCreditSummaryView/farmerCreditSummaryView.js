...
export default class GeneratePdf extends LightningElement {
    ...
    get mergedRecords() {
        ...
        // Iterate through formattedSales
        this.SaleInvoices.forEach(sale => {
            // Find the matching credit record based on InvoiceNumber
            const matchingCredit = this.FarmerCredits.find(credit => credit.Invoice_Number__c === sale.Name);
    
            // If a matching credit record is found, merge the fields
            if (matchingCredit) {
                mergedRecords.push({
                    // Sale Values
                    SaleId: sale.SaleId,
                    ...
                    date: sale.Invoice_Date__c,
                    Value: sale.Total_Invoice_Value__c,
                    PaymentType: sale.Payment_Type__c,
                    // Credit Values
                    CreditID: matchingCredit.Id,  
                    CreditName: matchingCredit.Name,
                    BalanceDue : matchingCredit.Balance_Due__c,
                    CreditInvoiceNumber : matchingCredit.Invoice_Number__c
        ...
        console.log(mergedRecords.length);
...
// }
    ...
    get formattedPurchases() {
        return this.Purchases.map(Purchase => ({
            ...
            PaddyPayment : Purchase.Grand_Total__c,
